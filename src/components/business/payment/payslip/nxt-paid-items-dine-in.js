...
function PaidItemsDineIn({ items }) {
  ...
  return (
    <Grid
      className="foodItem foodItemDineIn borderTopDouble"
      style={{ borderTop: '2px solid rgba(0,0,0,0.54)' }}
      container
    >
      <Grid
        className="foodItemTitle foodItemDineTitle"
...
export default PaidItemsDineIn;
